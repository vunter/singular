...
public class MyRequirementModule implements SingularModule {
    ...
    public static final String              MYREQUIREMENT = "MYREQUIREMENT";
    private             SingularRequirement myrequirement = new FormFlowSingularRequirement("MyRequirement", MyRequirementForm.class, MyRequirementFlow.class);
